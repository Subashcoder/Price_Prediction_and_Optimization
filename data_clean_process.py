...
def drop_unnecessary_columns(df):
    ...
    columns_to_drop = [
        ...
        'host_id'
        # Removed 'id' from here to retain it
    ]
...
def main():
    filepath = r"C:\Users\prabh\Downloads\airbnb_project\data\listing_oct_to_sept.csv"
    ...
    df.to_csv(r"C:\Users\prabh\Downloads\data\listing_1_WithID.csv", index=False)
    return df
